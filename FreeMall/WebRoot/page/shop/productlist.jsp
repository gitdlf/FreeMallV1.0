    ...
    <div class="plist">
        ...
        <!--分页-->
         <div class="mod_turn_page">
            ...
            <!--页面url缺pg的值-->
            <label id="pageUrl" style="display: none">${pageContext.request.contextPath }/category?cate=${CATE }&cateid=${CATEID}&pg=</label>
            <div class="turn_page" id="turnPage">
                <a href="${pageContext.request.contextPath }/category?cate=${CATE }&cateid=${CATEID}&pg=${PAGEBEAN.currentPage-1 }" class="page_prev page_index_start">上一页</a>
                <!--<a href="">1</a>
                <a href="">2</a>
                <a href="">3</a>-->
                <a href="${pageContext.request.contextPath }/category?cate=${CATE }&cateid=${CATEID}&pg=${PAGEBEAN.currentPage+1 }" class="page_prev">下一页</a>
            </div>
        </div>
    </div>
</div>
