        ...
        <div class="hd_content_right">
            <div class="hd_clearfix">
                ...
                <div class="hd_mini_cart">
                    <a href="${pageContext.request.contextPath }/control/querycart" class="hd_cart_name" id="hdCarName">购物车</a>
                    	...
                    	<%-- 购物车内容显示 --%>
		                        ...
		                        <div class="hd_tips">
		                                        ...
		                                        <c:forEach items="${sessionScope.CARTTAG }" var="item" varStatus="temp">
		                                        	<dd class="hd_cart_cur">
			                                            <div class="hd_cart_item">
			                                                <!--60*60-->
			                                                <img class="hd_pro_img" src="${pageContext.request.contextPath }/${item.goodsEntry.imageAddress }" alt="" width="50px" height="50px">
		                            ...
		                            <div class="hd_totla_pro">
		                                ...
		                                <a href="${pageContext.request.contextPath }/control/querycart" class="hd_cart_btn">打开购物车</a>
		                            </div>
		                        </div>
